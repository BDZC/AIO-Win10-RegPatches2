@echo off
Color 1F
Title Windows 10 Toggle Tweaker V3.3 By Yasser Da Silva
set CurV=3.3
...
ping -n 1 dl.dropboxusercontent.com >nul
if errorlevel 1 (
  cls
...
echo strFileURL = "https://dl.dropboxusercontent.com/s/rb0qwjsf9ptgpky/TWV.txt?dl=1" > TWV.vbs
...
echo   3. Enable/Disable stuff In Windows 10             บAบ Uninstall Candy Crush Saga  บ
echo   4. Speed Up PC Performance                        ศอน            9=^>11            บ
echo   5. Manage Microsoft Edge browser                  ษอฮอออออออออออออออออออออออออออออน
echo   6. Manage Updates                                 บBบ  Details in delete confirm  บ
echo   7. Manage Windows Features                        ศอน            2=^>15            บ
...
IF "%input%"=="A" (GOTO WAmenu)
IF "%input%"=="a" (GOTO WAmenu)
IF "%input%"=="B" (GOTO WFeedbackApp)
IF "%input%"=="b" (GOTO WFeedbackApp)
...
echo strFileURL = "https://dl.dropboxusercontent.com/s/ixrmazvutxvmci7/EDGETW.zip?dl=1" > EDGETW.vbs
...
echo strFileURL = "https://dl.dropboxusercontent.com/s/drqoalg6yoqe05i/install_wim_tweak.exe?dl=1" > IWT.vbs
...
echo strFileURL = "https://dl.dropbox.com/s/zfjqhqa6gjs4a7p/TWKMS.ZIP?dl=1" > KMS.vbs
...
echo strFileURL = "https://dl.dropboxusercontent.com/s/zzhc8tsjyw2jhqf/Lagecy-Calculator-Win10.exe?dl=1" > CALC64.vbs
echo     strHDLocation = "%CD%\Lagecy-Calculator-Win10.exe" >> CALC64.vbs
...
del CALC64.vbs
Lagecy-Calculator-Win10.exe
del Lagecy-Calculator-Win10.exe
...
echo strFileURL = "https://dl.dropboxusercontent.com/s/8q8le0uhx8x1s68/7TASKM-Win10.exe?dl=1" > 7TM.vbs
...
mode con:cols=65 lines=3
            ...
            echo  If Cortana is removed from system, it cannot be restored ^^!
...
echo strFileURL = "http://download1506.mediafire.com/fr0es8jxvsog/313ufw13shnw31p/Microsoft.Windows.Cortana_cw5n1h2txyewy.zip" > TWV.vbs
...
echo strFileURL = "https://dl.dropboxusercontent.com/s/hq0t7aqrysx0ss1/SetACL.zip?dl=1" > DVDappU.vbs
